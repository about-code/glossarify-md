...
const contentTypesAccept = new RegExp(`(${contentTypeJson}|${contentTypePlain})`);
        ...
        try {
            ...
            const req = https
                .get(url, {
                    ...
                    if (! contentType.match(contentTypesAccept)) {
                        req.destroy(`Invalid response. Expecting "Content-Type" header matching expression "${contentTypesAccept}" but got "${contentType}".`);
                        reject(`Invalid response. Expecting "Content-Type" header matching expression "${contentTypesAccept}" but got "${contentType}".`);
                    }

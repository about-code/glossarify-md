...
export class TermDefinition {
    ...
    constructor (data) {
        ...
        /** @type {string} */
        this.file = data.glossVFile.glossConf.file;
...
/**
 * @static
 * @param {TermDefinition} t1
 * @param {TermDefinition} t2
 */
TermDefinition.compare = function(t1, t2) {

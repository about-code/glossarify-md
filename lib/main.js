 ...
 * users themselves. When the configuration object was loaded from a file it must
 * have been augmented with a 'srcDir' property denoting the directory of the config
 * file. If 'srcDir' is missing 'baseDir' will be resolved relative to the process's

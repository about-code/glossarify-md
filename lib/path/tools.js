 ...
 * supported.
 *
 * @param {string} jsonFileNameOrUrl (only https:// or file://)
...
/*
 * Content Types supported to be read from a remote URL. For up to 10 content
 * types build a quality-weighted HTTP Accept header string
 * ~~~

 ...
 * Given
 * ~~~
 * fromParent = /home/user/foo/,
 * toChild = /home/user/foo/bar/baz.md
 * ~~~
 ...
 * @returns
 */
export function pathToChild(fromParent, toChild) {
    if (toChild instanceof VFile === false) {
        toChild = new VFile({ path: toChild });
    }
    return path
        .resolve(fromParent, toChild.path || "")
        .replace(fromParent, "")

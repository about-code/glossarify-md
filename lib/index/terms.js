...
export const IDX_OCCURRENCES_BY_TEXT = "term_occ";
export const IDX_TERMS_BY_ID = "termById"
export const IDX_TERMS_BY_PHRASE = "termByHash";
export const IDX_TERMS = "terms";
export const IDX_TERMS_BY_GLOSSARY = "terms_by_glossary";
export const indexes = [{
    id: IDX_OCCURRENCES_BY_TEXT
    ,title: "Book Index"
...
,{
    ...
    ,title: "Glossary Terms"
    ,filterFn: (node) => node.type === TermDefinitionNode.type
    ,keyFn: (node) => node.valueHash /* use the constant-length hash of the term */
    ,conf: () => null
}
,{
    id: IDX_TERMS
...
export function getAST(context, indexFileConf) {
    ...
    if (indexFileConf.glossary) {
        ...
        const termOccEntries = getIndex(IDX_OCCURRENCES_BY_TEXT);
        (termsEntries[0] || [])
        ...
        indexEntries = getIndex(IDX_OCCURRENCES_BY_TEXT);
    }

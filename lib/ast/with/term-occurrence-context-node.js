 ...
 * @typedef {import('./term-occurrence-node').TermOccurrenceNode} TermOccurrenceNode
 */


const SYMBOL = "term-occurrence-context";
...
TermOccurrenceContextNode.syntax = () => {};
TermOccurrenceContextNode.fromMarkdown = () => {};
TermOccurrenceContextNode.toMarkdown = () => {
    return {
        handlers: { [SYMBOL]: () => "" }
    };
};

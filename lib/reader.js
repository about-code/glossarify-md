...
const {withTermDefinition} = require("./ast/with/term-definition");
const {withTermOccurrence} = require("./ast/with/term-occurrence");
        ...
        unifiedNgin(
            {
                processor: unified()
                    ...
                    .use(withTermDefinition)
                    .use(withTermOccurrence)
